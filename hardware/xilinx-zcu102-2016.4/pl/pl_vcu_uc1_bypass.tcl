...
CONFIG.CLK_OUT1_PORT {CORE} \
CONFIG.CLK_OUT2_PORT {MCU} \
CONFIG.CLK_OUT3_PORT {AXI_LITE} \
...
set_property -dict [list CONFIG.PSU__HIGH_ADDRESS__ENABLE {1}] [get_bd_cells zynq_ultra_ps_e_0]	 
  ...
  connect_bd_net -net clk_wiz_0_CORE [get_bd_pins clk_wiz_0/CORE] [get_bd_pins vcu_0/core_clk]
  connect_bd_net -net clk_wiz_0_MCU [get_bd_pins clk_wiz_0/MCU] [get_bd_pins vcu_0/mcu_clk]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x000800000000 [get_bd_addr_spaces vcu_0/DecData] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP1_DDR_HIGH
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces vcu_0/DecData] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0xC0000000 [get_bd_addr_spaces vcu_0/DecData] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  create_bd_addr_seg -range 0x40000000 -offset 0x000840000000 [get_bd_addr_spaces vcu_0/DecData] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP2_DDR_HIGH
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces vcu_0/DecData] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP2_DDR_LOW
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0xD0000000 [get_bd_addr_spaces vcu_0/DecData] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] SEG_zynq_ultra_ps_e_0_HP2_QSPI
